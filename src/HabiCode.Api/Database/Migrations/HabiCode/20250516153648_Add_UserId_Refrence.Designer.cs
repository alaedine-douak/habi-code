...
namespace HabiCode.Api.Database.Migrations.HabiCode
{
    ...
    [Migration("20250516153648_Add_UserId_Refrence")]
    partial class Add_UserId_Refrence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabiCode.Api.Entities.HabitTag", b =>
                {
                    ...
                    b.ToTable("habit_tags", "habi_code");
                });

            modelBuilder.Entity("HabiCode.Api.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("tags", "habi_code");
                });

            modelBuilder.Entity("HabiCode.Api.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.ToTable("users", "habi_code");
                });

            modelBuilder.Entity("HabiCode.Api.Entities.Habit", b =>
                {
                    b.HasOne("HabiCode.Api.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HabiCode.Api.Entities.HabitTag", b =>
                {
                    b.HasOne("HabiCode.Api.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("HabiCode.Api.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
